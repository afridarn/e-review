                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title">
                                        ...
                                        <a role="button" href="<?php echo base_url()?>index.php/managemytasks/addnewtask" aria-expanded="true">
                                    ADD NEW TASK
                                    </a>
                                    </h4>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="headingTwo">
                                    <h4 class="panel-title">
                                        ...
                                        <a  role="button"  href="<?php echo base_url()?>index.php/managemytasks/selectpotentialreviewer" aria-expanded="false">
                                     VIEW POTENTIAL REVIEWER
                                    </a>
                                    </h4>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="headingfour">
                                    <h4 class="panel-title">
                                        ...
                                        <a role="button" href="<?php echo base_url()?>index.php/managemytasks/confirmtaskcompletion" aria-expanded="true">
