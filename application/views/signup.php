    ...
    <section id="top_banner">
        <div class="banner">
            <div class="inner text-center">
                <h2>PROVIDING THE HIGHEST SERVICES</h2>
            </div>
        </div>
    </section>
                        ...
                        <div class="form-bottom">
                            <form role="form" action="" class="login-form">
                                <div class="input-group form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Name" aria-describedby="basic-addon1">
                                </div>
                                <div class="input-group form-group">
                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                ...
                                <div class="input-group form-group">
                                    ...
                                    <input type="password" class="form-control" id="katasandi" name="katasandi" placeholder="Password" aria-describedby="basic-addon1">
                                </div>
                                <div class="input-group form-group">
                                ...
                                <div class="input-group form-group">
                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                    <p>Roles :</p>
                                    <input type="checkbox" id="editor" name="roles[]" value="1"/>Editor </br>
                                    <input type="checkbox" id="reviewer" name="roles[]" value="2" />Reviewer
                                </div>
                              <!--  <div class="input-group form-group"> -->
                                    <!--<span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>-->
                                    <p>Photo :</p>
                                    <input type="file" class="form-control" id="userfile" name="userfile" placeholder="Photo" aria-describedby="basic-addon1">
                              <!--  </div> -->
                                
                                <button type="submit" class="btn" value="Sign-Up">Sign me up!</button>
                            </form>
                        </div>
                    </div>
