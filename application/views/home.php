...
<head>
    ...
    <title>eReview</title>
    <link rel="shortcut icon" type="image/jpg" href="<?php echo base_url()?>assets/logo.png"/>
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?php echo base_url()?>scss/main.css">
    <link rel="stylesheet" href="<?php echo base_url()?>scss/skin.css">
            ...
            <div class="container">
				...
				<span class="icon-bar"></span>
                        ...
                        <a class="navbar-brand" href="#">
                            <h1>EREVIEW</h1><span>Your Solutions</span></a>
                    </div>
                    <div id="navbar" class="collapse navbar-collapse navbar-right">
                        <ul class="nav navbar-nav">
                           ...
                           <!-- <li><a href="features.html">Features</a></li>
                            ...
                            <li><a href="<?php echo base_url() ?>index.php/welcome/signup">Sign Up</a></li>
    ...
    <div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <div class="fill" style="background-image:url('<?php echo base_url()?>img/banner-slide-1.jpg');"></div>
                <div class="carousel-caption slide-up">
                    <h1 class="banner_heading">Providing The <span>Highest </span>Services</h1>
                    <p class="banner_txt">Fix Your Articles Easily</p>
                   <!-- <div class="slider_btn">
                        <button type="button" class="btn btn-default slide">Sign Up</button>
                        <button type="button" class="btn btn-primary slide">Log In</button>
                    </div>-->
                </div>
            </div>
