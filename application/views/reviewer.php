                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title">
                                        ...
                                        <a role="button" href="<?php echo base_url()?>index.php/manageassignedtask/viewassignedtask" aria-expanded="true">
                                    VIEW ASSIGNED TASK
                                    </a>
                                    </h4>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="headingTwo">
                                    <h4 class="panel-title">
                                        ...
                                        <a  role="button"  href="<?php echo base_url()?>index.php/manageassignedtask/submitreview" aria-expanded="false">
                                     SUBMIT REVIEW
                                    </a>
                                    </h4>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="headingfour">
                                    <h4 class="panel-title">
                                        ...
                                        <a role="button" href="<?php echo base_url()?>index.php/manageassignedtask/withdraw_funds" aria-expanded="true">
                                   DEDUCT FUNDS
                                    </a>
                                    </h4>
                                </div>
