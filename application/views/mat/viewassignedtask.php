<body>
	<div align="center">
		...
		<table border="1">
			<caption>Requested Task</caption>
			<tr>
                <td>NO</td>
				<td>TASK ID</td>
				<td>TITLE</td>
				...
				{ foreach ($task1 as $item) 
					{ $i++;   ?>
						<tr>
							...
							<td><a href="<?php echo base_url() .'index.php/ManageAssignedTask/downloadFile/',$item['filename']; ?>" target="_blank"> Download </a></td>
							...
							<td><a href="<?php echo base_url() . 'index.php/ManageAssignedTask/AcceptTask/', $item['id_penugasan'];?>">Accept</a></td>
                            <td><a href="<?php echo base_url() . 'index.php/ManageAssignedTask/RejectTask/', $item['id_penugasan'];?>">Reject</a></td>
						<tr>
			<?php   }//tutup foreach 
				}//tutup if
				else {  ?>
